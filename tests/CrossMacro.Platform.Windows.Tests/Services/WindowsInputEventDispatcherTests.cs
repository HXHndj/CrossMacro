...
public sealed class WindowsInputEventDispatcherTests
{
    [Fact]
    public void Dispose_DrainsEventsInOrderOnOwnedThread()
    {
        ...
        using (var dispatcher = new WindowsInputEventDispatcher(
            inputEvent =>
            {
    ...
    public void Dispose_WhenCalledFromSubscriber_DoesNotDeadlock()
    {
        ...
        WindowsInputEventDispatcher? dispatcherReference = null;
        var dispatcher = new WindowsInputEventDispatcher(
            _ =>
            {
