...
public static class AppIcons
{
    ...
    private const string Keyboard = "M20,5H4C2.9,5 2,5.9 2,7V17C2,18.1 2.9,19 4,19H20C21.1,19 22,18.1 22,17V7C22,5.9 21.1,5 20,5M4,7H20V17H4V7M5,9H7V11H5V9M9,9H11V11H9V9M13,9H15V11H13V9M17,9H19V11H17V9M6,13H18V15H6V13";
